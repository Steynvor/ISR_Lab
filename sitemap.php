...
<title>Blue Business Site Map</title>
...
<style type="text/css"> 
#header_contact{
margin:20px 25px 0px 0px; /* you may need to change these margins if your contact info is larger, order is top, right, bottom, left*/
</style>
...
<div id="background_texture">
  <div id="wrapper">
    <div id="header">
      ...
      <div id="header_contact"><a href="contact.html"><img src="images/header_contact.png" alt="Contact us" width="195" height="52" border="0" /></a></div>
    </div>
    <div id="header_menu">
      <ul id="navigation">
    ...
    <div id="content_bg">
      <div class="top"><img src="images/content_box_top.gif" width="940" height="5" alt="top" /></div>
      <div id="left_column">
...
<!--end site map code-->
      ...
      <!--end left column-->
      <div id="right_column">
        <div class="top_title"> LATEST NEWS </div>
        <!--start news 1-->
        <div class="news_item">
      ...
      <div class="bottom"><img src="images/content_box_bottom.gif" width="940" height="5" alt="bottom" /></div>
    </div>
  </div>
  <div id="footer">
